...
# Script para lanzar children-terms-syn.py en bucle
...
for TIS in $TISSUES; do
    ...
    python3 ./children-terms-syn.py $OBO $TIS > $OUTDIR$TISNOSPACES-children-terms.tsv
    echo "Children terms for $TIS saved --> $OUTDIR$TISNOSPACES-children-terms.tsv"
done
